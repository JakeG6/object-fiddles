...
//book, movie, holiday. Have the values to those keys be your favorite thing in that category.

  //Code here
  var favoriteThings = {band: "Gorillaz", food:"Burrito", person:"Bernie Sanders",
  book:"House of Leaves", movie: "Blade Runner", holiday: "Halloween"};
...
//gender, married, eyeColor, hairColor. Fill those properties in with the appropriate values.
  ...
  //Code Here
  var alsoMe ={name: "Jake", age: 27, height: 76, gender: "male", married: false, eyeColor: "blue", hairColor: "brown"};

//Now, loop through your object and alert every value. *Tyler --> 24 --> 6'0 --> Male, etc etc

  //Code Here
  for (prop in alsoMe) {alert(prop);}
...
//Create an Object called 'album' with 5 keys named different song titles that you make up, with the values being the length of each song.
  ...
  //Code Here
  var album = {song1: 120, song2: 150, song3: 325, song4: 35, song5: 240};
...
console.log("right before states");
...
//(doesn't have to be accurate).
  ...
  //Code Here
  var states = {Alabama: 1000, Pennsylvania: 20000, Utah: 30500, Idaho: 4, Arkansas: 50000};
...
that each value is truthy. If it's not truthy, remove it from the object. */
  ...
  for (property in user1) {
    if (user1[property] != true) {
      delete user1[property];
    }
  }

//Once you get your truthy Object,
//Change the remaining values in the object to be specific to you
//(name: 'your name', username: 'your username'), rather than my information.

  //Code Here
  user1.name = "Jake";
  user1.username = "sixteenStrength";
  user1.pwHash = "asdfjkl";
...
credit card object.
   ...
   all the properties from the person as well as the creditcard. While Object.assign
...
function bindCard(person, creditCard){
  var boundCard = {};
  for (personalInfo in person) {
    boundCard[personalInfo] = person[personalInfo];
  }
  for (cardProp in creditCard) {
